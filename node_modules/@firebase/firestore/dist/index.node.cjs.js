    ...
    LocalDocumentsView.prototype.getDocumentsMatchingCollectionQuery = function (transaction, query) {
        ...
        return this.remoteDocumentCache
            ...
            return _this.addMissingBaseDocuments(transaction, mutationBatches, results).next(function (mergedDocuments) {
                ...
                try {
                    for (var mutationBatches_1 = tslib_1.__values(mutationBatches), mutationBatches_1_1 = mutationBatches_1.next(); !mutationBatches_1_1.done; mutationBatches_1_1 = mutationBatches_1.next()) {
                        var batch = mutationBatches_1_1.value;
                        try {
                            for (var _c = (e_4 = void 0, tslib_1.__values(batch.mutations)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var mutation = _d.value;
                    ...
                    try {
                        if (mutationBatches_1_1 && !mutationBatches_1_1.done && (_a = mutationBatches_1.return)) _a.call(mutationBatches_1);
                    }
    ...
    LocalDocumentsView.prototype.addMissingBaseDocuments = function (transaction, matchingMutationBatches, existingDocuments) {
        ...
        try {
            for (var matchingMutationBatches_1 = tslib_1.__values(matchingMutationBatches), matchingMutationBatches_1_1 = matchingMutationBatches_1.next(); !matchingMutationBatches_1_1.done; matchingMutationBatches_1_1 = matchingMutationBatches_1.next()) {
                ...
                try {
                    for (var _c = (e_6 = void 0, tslib_1.__values(batch.mutations)), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var mutation = _d.value;
            ...
            return _this.mutationQueue
                ...
                try {
                    for (var oldBatches_1 = tslib_1.__values(oldBatches), oldBatches_1_1 = oldBatches_1.next(); !oldBatches_1_1.done; oldBatches_1_1 = oldBatches_1.next()) {
                        ...
                        try {
                            for (var _e = (e_2 = void 0, tslib_1.__values(batch.mutations)), _f = _e.next(); !_f.done; _f = _e.next()) {
                                var mutation = _f.value;
                ...
                try {
                    for (var newBatches_1 = tslib_1.__values(newBatches), newBatches_1_1 = newBatches_1.next(); !newBatches_1_1.done; newBatches_1_1 = newBatches_1.next()) {
                        ...
                        try {
                            for (var _g = (e_4 = void 0, tslib_1.__values(batch.mutations)), _h = _g.next(); !_h.done; _h = _g.next()) {
    ...
    EventManager.prototype.onWatchChange = function (viewSnaps) {
        ...
        try {
            for (var viewSnaps_1 = tslib_1.__values(viewSnaps), viewSnaps_1_1 = viewSnaps_1.next(); !viewSnaps_1_1.done; viewSnaps_1_1 = viewSnaps_1.next()) {
                ...
                if (queryInfo) {
                    try {
                        for (var _c = (e_2 = void 0, tslib_1.__values(queryInfo.listeners)), _d = _c.next(); !_d.done; _d = _c.next()) {
...
var SyncEngine = /** @class */ (function () {
    ...
    SyncEngine.prototype.applyPrimaryState = function (isPrimary) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var activeTargets, activeQueries, activeQueries_1, activeQueries_1_1, queryData, activeTargets_1, p_1;
            var e_2, _a;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
    ...
    SyncEngine.prototype.applyActiveTargetsChange = function (added, removed) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var added_1, added_1_1, targetId, query, queryData, e_4_1, _loop_2, this_1, removed_1, removed_1_1, targetId, e_5_1;
            var e_4, _a, e_5, _b;
            var _this = this;
...
var WebStorageSharedClientState = /** @class */ (function () {
    ...
    WebStorageSharedClientState.prototype.start = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var existingClients, existingClients_1, existingClients_1_1, clientId, storageItem, clientState, onlineStateJSON, onlineState, _a, _b, event_1;
            var e_1, _c, e_2, _d;
            var _this = this;
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        try {
                            ...
                            try {
                                if (existingClients_1_1 && !existingClients_1_1.done && (_c = existingClients_1.return)) _c.call(existingClients_1);
                            }
                            finally { if (e_1) throw e_1.error; }
                        }
                        ...
                        try {
                            for (_a = tslib_1.__values(this.earlyEvents), _b = _a.next(); !_b.done; _b = _a.next()) {
                                event_1 = _b.value;
